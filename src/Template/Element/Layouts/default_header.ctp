                        ...
                        <div class="slimscroll noti-scroll">
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <?= $this->Html->image('/css/assets/images/users/avatar-2.jpg', ['class' => 'img-fluid rounded-circle']) ?>
                            ...
                            <a href="javascript:void(0);" class="dropdown-item notify-item">
                                <div class="notify-icon">
                                    <?= $this->Html->image('/css/assets/images/users/avatar-4.jpg', ['class' => 'img-fluid rounded-circle']) ?>
                                </div>
